...
reX.MediaManager = new Class({
    ...
    get: function(section, view, callback) {
		...
		var request = new Request.XML2JSON({
			...
			onSuccess: function(json){ 
                ...
                if (!this.cache.sections[section]) {
                    this.cache.sections[section] = {};
                }
                this.cache.sections[section][view] = json;
	...
	getAll: function(section, callback) {
		...
		var request = new Request.XML2JSON({
			...
			onSuccess: function(json){ 
                    ...
                    this.cache.sections[section]['all'] = json;
    ...
    getOnDeck: function(section, callback) {
		...
		var request = new Request.XML2JSON({
			...
			onSuccess: function(json){ 
                ...
                this.cache.sections[section]['onDeck'] = json;
	...
	getRecentlyAdded: function(section, callback, amount) {
		...
		var request = new Request.XML2JSON({
			...
			onSuccess: function(json){ 
                    ...
                    this.cache.sections[section]['recentlyAdded'] = json;
    ...
    getMyPlexQueue: function(callback) {
        
        var request = new Request.XML2JSON({
			url: 'https://my.plexapp.com/pms/playlists/', 
			method: 'get',
            async: false,
			onSuccess: function(json){ 
                this.current = json;
		...
		}).send('X-Plex-Token='+reX.myPlexToken);
    },
    
    getMyPlexWatched: function(callback) {
        
        var request = new Request.XML2JSON({
			url: 'https://my.plexapp.com/pms/playlists/watched', 
			method: 'get',
            async: false,
			onSuccess: function(json){ 
                this.current = json;
    ...
    getMyPlexUnwatched: function(callback) {
        
        var request = new Request.XML2JSON({
			url: 'https://my.plexapp.com/pms/playlists/unwatched', 
			method: 'get',
            async: false,
			onSuccess: function(json){ 
                this.current = json;
	...
	getSeasons: function(section, callback) {
		...
		var request = new Request.XML2JSON({
			...
			onSuccess: function(json){ 
                    this.current = json;
                    this.cache.sections[section] = json;
	...
	getTracks: function(section, callback) {
		...
		var request = new Request.XML2JSON({
			...
			onSuccess: function(json){ 
					...
					if(json.MediaContainer != undefined && json.MediaContainer.Track != undefined) {
	...
	getGroupedAlbums: function(section, callback) {
		...
		var request = new Request.XML2JSON({
				...
				onSuccess: function(json) {  
                    ...
                    this.cache.sections[section]['groupedAlbums'] = json;
    ...
    getAlbums: function(section, callback) {
        reX.debug('[MEDIAMANAGER] get albums for section ' + section, REX_INFO);
		...
		var request = new Request.XML2JSON({
				...
				onSuccess: function(json) {  
                    ...
                    this.cache.sections[section]['albums'] = json;
    ...
    getAlbumsAndTracks: function(section, callback) {
        this.getAlbums(section, function(albums) {
            albums.each(function(album, index) {
                if (!album['@key']) return;
                this.getTracks(album['@key'], function(tracks) {
                    album['tracks'] = tracks;
                }.bind(this));
            }.bind(this));
    ...
    getSectionInformations: function(key) {
       ...
       // console.log(this.current.MediaContainer['@viewGroup']);
